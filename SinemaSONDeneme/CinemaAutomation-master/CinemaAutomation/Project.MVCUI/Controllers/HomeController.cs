    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult ForgotPassword(AppUser item)
        {
            if (aprep.Any(x => x.Email == item.Email))
            {
                ...
                string gonderilecekMail = "Şifre sıfırlama talebiniz oluşturuldu. https://localhost:44317/Home/ResetPassword/" + yakalanan.ID + " linkine tıklayarak şifrenizi sıfırlayabilirsiniz.Kullanıcı adınız:"+item.UserName ;
